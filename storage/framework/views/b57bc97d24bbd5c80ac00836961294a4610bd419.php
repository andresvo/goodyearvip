...
<div class="container">
	<img src="<?php echo e(asset('assets/img/carta-icon.png')); ?>" alt="Carta" class="icon-float-carta" style="padding-right: 100px;">
	<h3>Formulario<br><b>de contacto</b></h3>
	<?php if($enviado): ?>
	Tu comentario ha sido enviado. Gracias por contactarnos.
	<?php else: ?>
	<form action="<?php echo e(url('contacto')); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/web/blog/resources/views/contacto.blade.php ENDPATH**/ ?>