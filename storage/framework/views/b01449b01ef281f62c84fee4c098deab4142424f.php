...
<div class="container form-pasos">
	...
	<?php if(!isset($codigo)): ?>
		...
		<?php endif; ?>
		<form action="<?php echo e(url('serviteca')); ?>">
			<div class="row">
	...
	<?php else: ?>
		...
		<?php else: ?>
		<form action="<?php echo e(url('compra/revisar')); ?>" onsubmit="return validar()" id="venta" method="post">
		...
		<div class="row">
			...
			<div class="form-group col-md-6">
				...
				<?php for($cant=$cupo;$cant>0;$cant--): ?>
					<option value="<?php echo e($cant); ?>"><?php echo e($cant); ?></option>
				<?php endfor; ?>
				</select>
			</div>
			<div class="form-group col-md-6">
	...
	<script type="text/javascript">
       (function() {
          $("#producto").change(function() {
             $.ajax({
                url: '<?php echo e(URL::to('/medida/listar')); ?>/' + $("#producto").val(),
                type: 'GET',
                dataType: 'JSON',
                beforeSend: function() {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/web/blog/resources/views/serviteca.blade.php ENDPATH**/ ?>