...
class ComprasExport implements FromArray, WithHeadings, ShouldAutoSize, WithEvents
{
	...
	public function array(): array
    {
		...
		foreach($compras as $c) {
			$sheet[] = [$c->email, $c->pnombre, $c->mnombre, $c->cantidad, $c->codigo, $c->precio, $c->boleta, $c->factura, $c->created_at];
		}
    ...
    {
        return ['Usuario', 'Diseño', 'Medida', 'Cantidad', 'Tarjeta', 'Precio unitario', 'Boleta', 'Factura', 'Fecha creación'];
	}
